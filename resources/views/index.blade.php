...
<html lang="en">
    <head>
        ...
        <title>Printer Strategy - Bootstrap 5 HTML Template</title>
    ...
    <body id="section_1">
        ...
        <nav class="navbar navbar-expand-lg bg-white shadow-lg">
            <div class="container">
                ...
                <a href="#" class="navbar-brand">Printer <span class="text-danger">Strategy</span></a>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link click-scroll" href="#section_2"><small class="small-title"><strong class="text-warning">02</strong></small> Priviews</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link click-scroll" href="#section_3"><small class="small-title"><strong class="text-warning">03</strong></small> Produk</a>
                        </li>
                    
                        <li class="nav-item">
                            <a href="login"><small class="small-title"><strong class="text-warning">04</strong></small> login</a>
                        </li>
                    </ul>
                <div>
                                ...
                                <div class="carousel-item active">
                                    <div class="container position-relative h-100">
                                        <div class="carousel-caption d-flex flex-column justify-content-center">
                                            ...
                                            <h1> <span class="text-warning"></span> Cari berbagai tiket  yang kamu butuhkan </h1>

                                            <div class="d-flex align-items-center mt-4">
                                                <a class="custom-btn btn custom-link" href="login">Login</a>
                                ...
                                <div class="carousel-item">
                                    <div class="container position-relative h-100">
                                        <div class="carousel-caption d-flex flex-column justify-content-center">
                                            ...
                                            <h1>Strategi Perjalanan Menyenangkan <span class="text-warning">next project</span></h1>
                        ...
                        <div class="col-lg-6 col-12 mb-5 mb-lg-0">
                            <div class="about-image-wrap h-100">
                                ...
                                <div class="about-image-info">
                                    <h4 class="text-white">Shello mutiara, CEO</h4>

                                    <p class="text-white mb-0">Kami Siap Membuat Perjalanan Anda Jadi Lebih Menyenangkan Dan Menarik.</p>
                                </div>
                            </div>
                        </div>
